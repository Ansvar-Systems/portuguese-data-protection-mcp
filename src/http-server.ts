...
const TOOLS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        query: { type: "string", description: "Search query in Portuguese (e.g., 'consentimento cookies', 'CGD')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific CNPD decision by reference number (e.g., 'Proc. 7054/2020').",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "Search CNPD guidance documents: orientações, diretrizes, and pareceres.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query in Portuguese" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description: "List all covered data protection topics with Portuguese and English names.",
      ...
      switch (name) {
        ...
        case "pt_dp_about": {
          return textContent({
            name: SERVER_NAME,
            version: pkgVersion,
            description: "CNPD (Comissão Nacional de Proteção de Dados) MCP server. Provides access to Portuguese data protection authority decisions, coimas, deliberações, and official guidance documents.",
